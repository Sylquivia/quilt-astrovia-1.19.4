...
public class AstroviaBlocks {
	...
	public static final Block NEW_PIPE = new NewPipe(QuiltBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque());
	public static void register(ModContainer mod) {
		...
		Registry.register(Registries.BLOCK, new Identifier(mod.metadata().id(), "new_pipe"), NEW_PIPE);
	}
}
